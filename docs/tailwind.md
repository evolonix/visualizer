...
The custom tailwind library found at `/libs/shared/apollo/tailwind` is installed as a local npm package. This allows us to reference it from other projects' Tailwind CSS configs.
