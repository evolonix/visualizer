...
export const AppSearch = ({ query, open, onClose }: AppSearchProps) => {
  ...
  return (
    <>
      <div className="pointer-events-none absolute left-4 top-3.5 h-5 w-5 text-neutral-400"></div>
      <style>{`
        .search-spinner {
      ...
      >
        <Dialog as="div" className="relative z-50" onClose={onClose}>
          ...
          <div className="fixed inset-0 z-50 w-screen overflow-y-auto p-4 sm:p-6 md:p-48">
            ...
            >
              <DialogPanel className="mx-auto max-w-xl transform divide-y divide-neutral-100 overflow-hidden rounded-xl bg-white shadow-2xl ring-1 ring-black ring-opacity-5 transition-all">
                {/* <Form role="search"> */}
                <Combobox>
                  <div className="relative border-b border-neutral-200">
                    <MagnifyingGlassIcon
                      className={clsx(
                        isSearching ? 'hidden' : '',
                        'pointer-events-none absolute left-4 top-3.5 h-5 w-5 text-neutral-400',
                      )}
                      aria-hidden="true"
                    />
                    <ComboboxInput
                    ...
                    />
                    <div
                      className="search-spinner pointer-events-none absolute left-4 top-3.5 h-5 w-5 text-neutral-400"
                      aria-hidden
                      hidden={!isSearching}
                    />
                  </div>
