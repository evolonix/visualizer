...
export const defaultConfiguration = {
  ...
  logos: [
    {
      url: '/logos/degreed-small.png', // TODO: Replace with real location
      size: 'small',
    },
    {
      url: '/logos/degreed-wide.png', // TODO: Replace with real location
      size: 'wide',
    },
  ],
  features: {
  ...
  productSwitcherNavigation: [
    ...
    {
      text: 'Degreed Skills',
      title: 'Degreed Skills',
      product: 'skills-platform',
      subItems: [
        {
          text: 'Home',
          href: '/home',
...
} satisfies Required<AppLayoutConfiguration>;
// } satisfies Omit<Required<AppLayoutConfiguration>, 'navigation' | 'productSwitcherNavigation'>;
